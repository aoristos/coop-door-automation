...
// ATTENTION-ADJUST: adjust appropriate offset parameters:
  ...
  /* In case the DS1307RTC is running in summertime modus (daylight saving time values)(zomertijd) ...
   * we have to subtract 1 hour from the clock-reading (tm.Hour - summerTimeOffset) ...
   * because the sunRise[] and sunSet[] ephemerides in this sketch are expressed all in wintertime values.
  */
// ATTENTION-ADJUST:
